...
/* package w6-0.1.0.0 */
#define VERSION_w6 "0.1.0.0"
#define MIN_VERSION_w6(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "w6-0.1.0.0-W9Ugrx6kTHIl3x6l8azM"

#define CURRENT_PACKAGE_KEY "w6-0.1.0.0-W9Ugrx6kTHIl3x6l8azM"
